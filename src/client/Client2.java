...
public class Client2 {
    ...
    private Client2(String destinationAddr, int port) throws IOException {
    ...
    public void testServerConnection() throws IOException {
        ...
        if (connected) {
            ...
            System.err.println("The server is unreachable at this moment");
            System.exit(1);
        }
    ...
    public static void main(String[] args) {
        ...
        try {
            Client2 sender = new Client2(args[0], Integer.parseInt(args[1]));
            ...
            System.err.println("Look what they've done to my boy!");
            showUsage();
        }
    }
}