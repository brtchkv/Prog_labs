...
public class FileHandler {
    ...
    public static String getFileName() {
        ...
        try {
            collectionPath = System.getenv("HUMAN_PATH").trim();
            ...
            if (collectionPath == null) {
                return "The environment variable HUMAN_PATH is not set!";
                //return null;
            ...
            return ("Some error, in an attempt to get the file name!\nCheck out the environment variable.");
            //return null;
        }
     ...
     */
    public static void save(Set<Human> humans){
    ...
    public static LinkedHashSet convertToLinkedHashSetFromString(String[] array){
        ...
        try {
            ...
            System.out.println("Some error, in an attempt to import the collection!");
            humans = null;
            savePermission = false;
        }
        return humans;
